...
<div class="rounded-xl border border-border bg-card p-3 shadow-sm hover:shadow-md transition-all duration-150 {borderClass}">
  <!-- Header -->
  ...
  <div class="grid grid-cols-2 gap-3">
    <!-- Moco side -->
    <div class="rounded-lg border border-border/50 bg-background/50 p-2">
